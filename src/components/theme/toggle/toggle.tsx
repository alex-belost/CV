...
export function Toggle() {
    ...
    return (
        <button
            ...
            className={cn(
                "group relative inline-flex h-9 w-16 cursor-pointer items-center rounded-full px-1 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
                isDark
        ...
        >
            ...
            <div className="absolute inset-0 flex items-center justify-between px-2 text-[10px] font-bold uppercase tracking-wider">
                <span className={cn("transition-all duration-300 transform", isDark ? "opacity-0 -translate-x-2 group-hover:translate-x-0 group-hover:opacity-100 text-yellow-500" : "opacity-0")}>
                    <svg
                ...
                <span className={cn("transition-all duration-300 transform", isDark ? "opacity-0" : "opacity-0 translate-x-2 group-hover:translate-x-0 group-hover:opacity-100 text-slate-500")}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
